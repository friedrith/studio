...
interface TogglTrackOptions extends PluginOptions {
  isTracking: boolean
...
export default class TogglTrack extends Plugin {
  interval: any
  ...
  async getData(data: PluginOptions): Promise<TogglTrackOptions> {
